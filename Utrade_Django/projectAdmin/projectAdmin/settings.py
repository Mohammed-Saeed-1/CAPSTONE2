...
SECRET_KEY = 'django-insecure-pelv514gt56b88!y-dsrl!=m!*0p5r#*&1)^-0-ksx*pui3^h2'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [ os.path.join(BASE_DIR, 'projectAdmin/static') ]
